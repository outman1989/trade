...
@Setter
@NoArgsConstructor
@Table(name = "product_pig")
public class ProductPigEntity implements java.io.Serializable {
    /** 版本号 */
     ...
     * 猪源初始化
     */
    public ProductPigEntity init(String id,String accountId,String shopId) {
        this.id = id;
        this.accountId = accountId;
        this.shopId = shopId;
        this.sysState = SysStateEnum.正常.getCode();//系统状态
        this.productState = ProductStateEnum.上架.getCode();//猪源状态
        this.soldStock = 0;//已售库存
        this.preference = false;//优选
        this.idPig = false;//ID猪
