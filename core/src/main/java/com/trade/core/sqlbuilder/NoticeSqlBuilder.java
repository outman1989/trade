...
public class NoticeSqlBuilder extends BaseSqlBuilder<NoticeEntity> {

    private static final String TABLE = SqlConfig.Table(NoticeEntity.class);
    ...
    public String addBatch(Map<String, Object> parameters) {
        return super._add((List<NoticeEntity>) parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update(Map<String, Object> parameters) {
        return super._update((NoticeEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch(Map<String, Object> parameters) {
        return super._updateBatch((List<NoticeEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
