 ...
 * 账号 sqlbuilder
 * @author lx
 * @since 2018-6-7 16:27:15
 */
@SuppressWarnings("unused")
public class AccountSqlBuilder extends BaseSqlBuilder<AccountEntity> {

    private static final String TABLE = SqlConfig.Table(AccountEntity.class);
    ...
    public String addBatch (Map<String, Object> parameters) {
        return super._add((List<AccountEntity>)parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update (Map<String, Object> parameters) {
        return super._update((AccountEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch (Map<String, Object> parameters) {
        return super._updateBatch((List<AccountEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
