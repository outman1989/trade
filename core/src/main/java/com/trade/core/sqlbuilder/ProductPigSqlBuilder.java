...
public class ProductPigSqlBuilder extends BaseSqlBuilder<ProductPigEntity> {

    private static final String TABLE = SqlConfig.Table(ProductPigEntity.class);
    ...
    public String addBatch(Map<String, Object> parameters) {
        return super._add((List<ProductPigEntity>) parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update(Map<String, Object> parameters) {
        return super._update((ProductPigEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch(Map<String, Object> parameters) {
        return super._updateBatch((List<ProductPigEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
