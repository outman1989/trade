 ...
 *
 * @author lx
 * @since 2018-6-6 15:12:16
 */
@SuppressWarnings("unused")
public class SysDictionarySqlBuilder extends BaseSqlBuilder<SysDictionaryEntity> {

    private static final String TABLE = SqlConfig.Table(SysDictionaryEntity.class);
    ...
    public String addBatch(Map<String, Object> parameters) {
        return super._add((List<SysDictionaryEntity>) parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update(Map<String, Object> parameters) {
        return super._update((SysDictionaryEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch(Map<String, Object> parameters) {
        return super._updateBatch((List<SysDictionaryEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
