...
public class WantBuySqlBuilder extends BaseSqlBuilder<WantBuyEntity> {

    private static final String TABLE = SqlConfig.Table(WantBuyEntity.class);
    ...
    public String addBatch(Map<String, Object> parameters) {
        return super._add((List<WantBuyEntity>) parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update(Map<String, Object> parameters) {
        return super._update((WantBuyEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch(Map<String, Object> parameters) {
        return super._updateBatch((List<WantBuyEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
