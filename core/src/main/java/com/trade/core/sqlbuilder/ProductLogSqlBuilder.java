...
public class ProductLogSqlBuilder extends BaseSqlBuilder<ProductLogEntity> {

    private static final String TABLE = SqlConfig.Table(ProductLogEntity.class);
    ...
    public String addBatch(Map<String, Object> parameters) {
        return super._add((List<ProductLogEntity>) parameters.get(SqlConfig.PARAM_LIST), SqlConfig.EXCLUDE_SERIALVERSIONUID, TABLE);
    }
    ...
    public String update(Map<String, Object> parameters) {
        return super._update((ProductLogEntity) parameters.get(SqlConfig.PARAM_ENTITY), SqlConfig.DEFAULT_ID, SqlConfig.EXCLUDE_ID_AND_SERIALVERSIONUID, TABLE);
    }
    ...
    public String updateBatch(Map<String, Object> parameters) {
        return super._updateBatch((List<ProductLogEntity>) parameters.get(SqlConfig.PARAM_LIST), (String) parameters.get(SqlConfig.PARAM_FIELDS), TABLE);
    }
