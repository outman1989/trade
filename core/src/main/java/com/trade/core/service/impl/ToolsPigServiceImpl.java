...
import com.trade.core.mapper.IToolsPigMapper;
...
public class ToolsPigServiceImpl<E> extends BaseServiceImpl implements IToolsPigService<E> {
    @Autowired
    private SnowflakeIdUtil snowflakeIdUtil;
    @Autowired
    private IToolsPigMapper mapper;

    @Transactional
    @Override
    @SuppressWarnings("unchecked")
    public ResponseData<Object> save(JSONObject jo) {
        return super._save(mapper, jo.getJSONObject(SqlConfig.PARAM_ENTITY), null, ToolsPigEntity.class, snowflakeIdUtil);
    }
